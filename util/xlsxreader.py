...
class XlsxReader:
    def __init__(self, path):
        ...
        self.openSheetName_ = ""  # 记录当前打开的sheet名称
        self.openSheetHeader_ = [] # 记录当前打开的sheet header
    ...
    def openSheet(self, sheetName):
        ...
        self.openSheetName_ = sheetName
        self.sheetMaxRows_ = self.ws_.max_row
        self.sheetMaxCols_ = self.ws_.max_column
        self.sheetCurRow_ = 2
        self.openSheetHeader_ = self.getSheetHeader()

    def closeSheet(self):
        self.ws_ = None
        self.openSheetName_ = ""
        self.openSheetHeader_ = []
        self.sheetMaxRows_ = 0
        self.sheetMaxCols_ = 0
        self.sheetCurRow_ = 2

    def getSheetHeader(self):
        if self.ws_ is None:
            return []
    ...
    def readAllData(self):
        if self.ws_ is None:
            return {}
        listRecord = []
        for row in range(self.sheetCurRow_, self.sheetMaxRows_ + 1):
            dictRecord = {}
